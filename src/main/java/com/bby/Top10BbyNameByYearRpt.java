...
public class Top10BbyNameByYearRpt {
    private LinkedList<BabyName> nameLinkedList;
    private DataWriteValidation dwv = new DataWriteValidation();

    public Top10BbyNameByYearRpt(LinkedList<BabyName> nameLinkedList) {
        this.nameLinkedList = nameLinkedList;
        System.out.println("Top 10 Baby name by Year Report");
        System.out.println("--------------------------------");
    }
    ...
    public void reportName(){
        ...
        System.out.println("Top 10 Baby Name list for Male in ::" + searchYear);
        ...
        asciiTable.addRule();
        int no = 1;
        maleList.sort(Comparator.comparing(BabyName::getRank));
        ...
        System.out.println("Top 10 Baby Name list for Female in :: " + searchYear);
        ...
        asciiTable.addRule();
        no = 1;
        femaleList.sort(Comparator.comparing(BabyName::getRank));
